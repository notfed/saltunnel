...
//  saltunnel
//
//  This implementation of 'cache' is simply a hash table with the
//  additional property that it will only allow CACHE_NUM_ENTRIES_MAX
//  number of entries at a time. Once this limit is reached, each new
//  entry added will result in the oldest entry being deleted.
//
