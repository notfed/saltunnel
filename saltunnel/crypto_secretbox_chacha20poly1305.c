//
//  crypto_secretbox_chacha20poly1305.c
//  saltunnel2
//
...
int
crypto_secretbox_chacha20poly1305(unsigned char *c, const unsigned char *m,
                                  ...
                                  const unsigned char *k)
{
    ...
    crypto_stream_chacha20_xor(c, m, mlen, n, k);
...
int
crypto_secretbox_chacha20poly1305_open(unsigned char *m, const unsigned char *c,
                                       ...
                                       const unsigned char *k)
{
    ...
    crypto_stream_chacha20_xor(m, c, clen, n, k);
    for (i = 0; i < 32; ++i) {
        m[i] = 0;
    }
    return 0;
...
size_t
crypto_secretbox_chacha20poly1305_messagebytes_max(void)
{
    return crypto_secretbox_chacha20poly1305_MESSAGEBYTES_MAX;
}

void
crypto_secretbox_chacha20poly1305_keygen(unsigned char k[crypto_secretbox_chacha20poly1305_KEYBYTES])
{
    randombytes_buf(k, crypto_secretbox_chacha20poly1305_KEYBYTES);
}
