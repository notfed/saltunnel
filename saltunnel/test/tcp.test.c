...
static void tcp_test_connect_to_invalid_hostname() {
    // Create TCP client
    tcpclient_options client_options = { .OPT_TCP_NODELAY = 1, .OPT_CONNECT_TIMEOUT = 5000 };
    oops_should_warn();
...
static void tcp_test_connect_to_bad_subnet() {
    // Create TCP client
    tcpclient_options client_options = { .OPT_TCP_NODELAY = 1, .OPT_CONNECT_TIMEOUT = 100 };
    oops_should_warn();
...
void tcp_tests() {
    ...
    tcp_test_connect_to_invalid_hostname();
